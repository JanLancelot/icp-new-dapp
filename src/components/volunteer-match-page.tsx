    ...
    <div className="min-h-screen bg-gray-50">
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-6"></div>
          ...
          <div className="flex flex-col md:flex-row items-center bg-white rounded-lg overflow-hidden shadow-lg">
            ...
            <div className="p-8 md:w-2/3">
              ...
              <p className="text-gray-600 mb-4">
                Bayani empowers Filipinos to create positive change by matching
                volunteers with causes that matter. Whether you're passionate
                about education, the environment, or community development,
                Bayani helps you find the perfect fit.
              </p>
              <p className="text-gray-600 mb-4">
                We make it easy for volunteers not only to give their time but
                also to donate and support causes close to their hearts, further
                amplifying their impact.
              </p>
              <p className="text-gray-600">
                Our platform simplifies the process for organizers, automating
                tasks like posting volunteer opportunities and managing events,
                so you can focus on what really matters—building a better
                Philippines.
              </p>
            </div>
          </div>
